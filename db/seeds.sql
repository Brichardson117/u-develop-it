...
VALUES 
('James', 'Fraser', 'j@goldenbough.edu'),
('Jack', 'London', 'jlondon@ualaska.edu'),
('Robert', 'Bruce', 'rbruce@scotland.net'),
('Peter', 'Greenway', 'pgreenway@postmodern.com'),
...
INSERT INTO parties (party_name, insert_description)
VALUES
('JS Juggernauts', 'The JS Juggernauts eat, breath, and sleep JavaScript. They can build everything you could evern want in JS, including a new kitchen sink.'),
('Heroes of HTML', 'Want to see a mock-up turn into an actual webpage in a matter on minutes? Well, the Heroes of HTML can get it done in a matter of seconds. '),
('Git Gurus', 'Need to resolve a merge confilct? The Git Gurus have your back. Nobody knows Git like these folks do.');
